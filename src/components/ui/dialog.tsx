  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "w-[calc(100vw-32px)] max-w-[540px] rounded-3xl border border-slate-900/10 bg-white p-6 text-slate-900 shadow-2xl dark:border-blue-400/15 dark:bg-[#101827] dark:text-white md:p-8",
          className,
