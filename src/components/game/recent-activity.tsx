  ...
  return (
    <section className="w-full border-t border-slate-900/10 bg-slate-100/30 py-16 transition-colors dark:border-blue-400/20 dark:bg-white/[0.03]">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="overflow-hidden rounded-[32px] border border-slate-900/10 bg-white shadow-[0_2px_16px_rgb(15_23_42_/_0.07)] transition-all dark:border-blue-400/20 dark:bg-[#0e1629] dark:shadow-[0_4px_24px_rgb(0_0_0_/_0.4)]">
