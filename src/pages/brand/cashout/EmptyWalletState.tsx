...
function EmptyWalletState({ onAddFirstWallet }: EmptyWalletStateProps) {
  return (
    <div className="rounded-2xl border border-dashed border-primary/10 bg-primary/[0.02] py-16 text-center">
      ...
      <button
        className="inline-flex cursor-pointer items-center gap-2.5 rounded-full bg-primary px-8 py-3.5 text-base font-bold text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary-hover active:scale-95"
