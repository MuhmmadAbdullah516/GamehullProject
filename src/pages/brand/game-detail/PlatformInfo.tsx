import type { PlatformDetails } from "@/types/games";
...
function PlatformInfo({ details }: PlatformInfoProps) {
  return (
    <div className="space-y-6">
      <article className="rounded-[32px] border border-slate-900/10 bg-white p-8 transition-all duration-200 dark:border-blue-400/20 dark:bg-[#0e1629] md:p-10">
      ...
      <article className="relative overflow-hidden rounded-[32px] border border-slate-900/10 bg-primary p-8 text-white shadow-[0_2px_16px_rgb(15_23_42_/_0.07)] transition-all duration-200 dark:border-blue-400/20 dark:bg-[linear-gradient(160deg,#021020_0%,#140540_100%)]">
