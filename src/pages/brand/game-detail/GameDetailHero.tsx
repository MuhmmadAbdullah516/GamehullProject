      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
        ...
        <div className="flex flex-col items-center gap-8 md:flex-row md:gap-12">
          ...
          <div className="text-center md:text-left">
            <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-600/20 bg-blue-600/[0.07] px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-primary transition-colors duration-200 dark:border-blue-400/25 dark:bg-blue-600/10 dark:text-blue-200">
