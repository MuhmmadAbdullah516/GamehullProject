...
function GameDetailHero({ game }: GameDetailHeroProps) {
  return (
    <section className="relative overflow-hidden bg-white py-12 md:py-20 pb-8 md:pb-13 transition-colors dark:bg-[#080d1c]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
        ...
        <div className="flex flex-col items-center gap-8 md:flex-row md:gap-12">
          <div className="group relative size-35 shrink-0 overflow-hidden rounded-[32px] border border-slate-900/10 shadow-[0_2px_16px_rgb(15_23_42_/_0.07)] dark:border-blue-400/20 dark:shadow-[0_4px_24px_rgb(0_0_0_/_0.4)] md:size-45 md:rounded-[40px]">
            <img
              alt={game.name}
          ...
          <div className="text-center md:text-left">
            ...
            <p className="max-w-140 text-[15px] leading-relaxed text-slate-600 transition-colors duration-200 dark:text-zinc-400 md:text-base">
              {game.description}
            </p>
          </div>
        </div>
