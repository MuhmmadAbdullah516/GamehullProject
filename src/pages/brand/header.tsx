      ...
      <div className="mx-auto flex h-18 max-w-285 items-center justify-between px-5">
        ...
        <div className="flex shrink-0 items-center gap-2 md:gap-2.5">
          ...
          <Button
            ...
            className="flex size-10.5 cursor-pointer items-center justify-center rounded-full border-[1.5px] border-slate-900/10 bg-slate-100 text-slate-500 transition-all active:scale-95 dark:border-blue-400/15 dark:bg-white/[0.06] dark:text-white/55 lg:hidden"
            onClick={handleMenuToggle}
            size="icon"
            type="button"
            variant="outline"
          >
            {isMenuOpen ? <X className="size-5.5" strokeWidth={2.5} /> : <Menu className="size-5.5" strokeWidth={2.5} />}
          </Button>
        </div>
      </div>
