...
function SpinWheelCard(props: SpinWheelCardProps) {
  ...
  return (
    <section className="grid min-h-95.25 grid-cols-[minmax(0,1fr)_415px] items-center gap-13.5 rounded-[32px] border border-slate-900/10 bg-white bg-[linear-gradient(135deg,rgba(37,99,235,0.04)_0%,transparent_100%)] px-9 py-12 shadow-[0_2px_16px_rgb(15_23_42_/_0.07)] transition duration-300 hover:border-blue-600/20 dark:border-blue-400/20 dark:bg-[#0e1629] dark:bg-[linear-gradient(135deg,rgba(37,99,235,0.08)_0%,transparent_100%)] max-lg:grid-cols-1 max-lg:gap-12 max-lg:p-8">
      <div>
        <span className="inline-flex h-6.75 items-center rounded-full border border-blue-600/20 bg-blue-600/[0.07] px-3.5 text-sm font-bold text-[#1D4ED8] dark:border-blue-400/25 dark:bg-blue-600/10 dark:!text-[#BFDBFE]">Daily Bonus</span>
        <h2 className="mb-4 mt-5 max-w-145 text-[clamp(28px,3vw,40px)] font-black leading-[1.2] tracking-normal text-[#0F172A] dark:!text-[#FFFFFF]">Spin the Wheel & Win</h2>
        <p className="max-w-141.5 text-base leading-[1.6] text-[#475569] dark:!text-[#A1A1AA]">
        ...
        <div className="mt-8 w-full max-w-108.25 rounded-2xl border border-slate-900/10 bg-slate-100 px-6 py-5 transition duration-300 hover:border-blue-600/20 dark:border-blue-400/20 dark:bg-white/[0.06]">
      ...
      <div className="grid place-items-center max-lg:-order-1">
        <div className="relative grid aspect-square w-80 place-items-center rounded-full border border-black/5 bg-black/[0.02] shadow-[0_2px_16px_rgb(15_23_42_/_0.07)] max-sm:w-[min(320px,86vw)]">
          <div className="relative flex size-71.5 items-center justify-center rounded-full bg-[linear-gradient(135deg,#2563eb,#7c3aed)] p-1 opacity-80 shadow-xl">
          ...
          <Button className="absolute z-40 grid aspect-square size-21 place-items-center rounded-full border-[6px] border-white bg-primary text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50" disabled={spinDisabled} onClick={props.onSpin} type="button">
