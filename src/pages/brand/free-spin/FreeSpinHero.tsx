function FreeSpinHero() {
  return (
    <section className="relative overflow-hidden border-b border-border bg-white bg-[linear-gradient(180deg,#ffffff_0%,#f0f5ff_100%)] py-12 pb-8 text-center transition-colors duration-300 ease-out dark:border-blue-400/15 dark:bg-[#080d1c] dark:bg-[radial-gradient(ellipse_85%_55%_at_50%_-5%,rgba(29,78,216,0.48)_0%,transparent_65%),linear-gradient(#080d1c,#080d1c)] md:py-20 md:pb-[3.25rem]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6">
        ...
        <p className="mx-auto max-w-[37.5rem] text-base leading-relaxed text-[#475569] dark:!text-[#A1A1AA] md:text-lg">
