...
function PrizeHistory({ history, show }: PrizeHistoryProps) {
  ...
  return (
    <section className="mt-12 rounded-[1.625rem] border border-slate-900/10 bg-white p-8 shadow-[0_2px_16px_rgb(15_23_42_/_0.07)] transition duration-300 hover:border-blue-600/20 dark:border-blue-400/20 dark:bg-[#0e1629] dark:shadow-[0_4px_24px_rgb(0_0_0_/_0.4)] max-sm:rounded-3xl max-sm:p-6">
      <div className="mb-8 flex items-center justify-between gap-5">
        <h2 className="text-2xl font-black tracking-normal text-[#0F172A] dark:!text-[#FFFFFF]">
          Prize History
        </h2>
        <Button className="h-9 rounded-full border border-primary/10 bg-primary/5 px-4 text-sm font-bold text-[#2563EB] hover:bg-primary/10" type="button" variant="outline">
          View All
        </Button>
      </div>
      ...
      {history.length > 0 ? (
        ...
        <div className="flex min-h-[13.75rem] flex-col items-center justify-center rounded-2xl text-center text-sm text-[#64748B] dark:!text-white/55">
