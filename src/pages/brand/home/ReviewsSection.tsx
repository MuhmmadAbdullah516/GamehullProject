      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6">
        <div className="mb-[clamp(32px,4vw,52px)] text-center">
          <div className="mb-3.5 inline-flex items-center gap-1.5 rounded-full border border-blue-600/20 bg-blue-600/[0.07] px-3.5 py-1 transition-colors dark:border-blue-400/25 dark:bg-blue-600/10">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-blue-700 dark:text-blue-200">Player Reviews</span>
          </div>
          <h2 className="m-0 text-[clamp(28px,4vw,40px)] font-black leading-tight text-slate-900 transition-colors dark:text-white">
