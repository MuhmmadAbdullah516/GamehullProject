    ...
    <section className={`${sectionRevealClass} relative overflow-hidden border-t border-slate-900/10 bg-[#f8fbff] py-14 md:py-24 transition-colors duration-300 ease-out dark:border-blue-400/15 dark:bg-[#06101f]`}>
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl gap-8 md:gap-18 px-6 lg:grid-cols-[1fr_1fr] lg:items-center">
        <div className="flex flex-col gap-[22px]">
          ...
          <p className="max-w-[420px] text-[14.5px] leading-[1.75] text-slate-600 transition-colors dark:text-zinc-400">
          ...
          <Button asChild className="mt-8 !h-auto w-fit self-start rounded-full bg-gradient-to-br from-[#16a34a] to-[#22c55e] px-7 py-3.5 text-sm font-extrabold text-[#14532d] no-underline shadow-[0_0_28px_rgba(34,197,94,.3)] transition-all duration-150 hover:-translate-y-[2px]">
